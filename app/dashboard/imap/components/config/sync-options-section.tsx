...
export function SyncOptionsSection({
  ...
  // Keep parent in sync with local formData on mount and when syncOptions prop changes
  useEffect(() => {
    setFormData(syncOptions);
    onOptionsChange(syncOptions);
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Number of messages to process at once. Larger batches can be
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Number of times to retry failed operations. Higher values can
                help with temporary issues but may slow down the process.
              </p>
              <div className="flex items-center space-x-2">
                <Slider
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Time to wait between retries. Longer delays can help with rate
                limiting but slow down recovery.
              </p>
              <div className="flex items-center space-x-2">
                <Slider
                  value={[formData.retryDelay]}
                  onValueChange={(value) =>
                    handleChange("retryDelay", value[0])
                  }
                  min={0}
                  max={5000}
                  step={100}
              ...
              <div className="flex items-center">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleChange("skipExistingMessages", checked)
                  }
                />
              </div>
              <div className="space-y-1 leading-none">
            ...
            <div className="flex flex-row items-start space-x-3 space-y-0">
              <div className="flex items-center">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleChange("calculateStats", checked)
                  }
                />
              </div>
              <div className="space-y-1 leading-none">
